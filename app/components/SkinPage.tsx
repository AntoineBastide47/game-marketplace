              ...
              <div className="mb-3">
                {account ? (
                  <button
                    ...
                    className="w-full bg-green-600 hover:bg-green-700 text-white font-bold py-3 rounded-md transition-colors flex items-center justify-center gap-2 text-base"
                  >
